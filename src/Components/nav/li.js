...
const LiTags = ({path,setPath}) => {
  ...
  return (
    <>
      ...
      <li className={`${path == '/About'&& 'border-b-4 border-pink-400'} whitespace-nowrap `} onClick={() =>  setPath(window.location.pathname)} > <Link to='/About' >About Us</Link> </li>
      ...
      <li className={`${path == '/Contact' && 'border-b-4 border-pink-400'} whitespace-nowrap `} onClick={() =>  setPath(window.location.pathname) }> <Link to='/Contact'>Contact Us</Link> </li>
