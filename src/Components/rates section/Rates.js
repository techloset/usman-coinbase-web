...
import pathTop from "../../Images/rates/pt.png";
import pathBottom from "../../Images/rates/pb.png";
import "./rates.css";
const Rates = () => {
  return (
    <div
      ...
      className="relative"
    >
      <img src={pathTop} className="w-full" alt="" />
      <div className="w-full bg-center  bg-no-repeat bg-cover flex  justify-center">
        <div className="w-[80%] sm:w-[50%] lg:w-[1000px] h-[320px] pb-2 mt-10 mb-[50px] shadow-xl scroll scroll rounded-3xl overflow-y-auto  bg-white ">
          ...
          <div className="flex flex-col lg:flex-row justify-center gap-12 items-center  ">
            ...
            <p className="block lg:hidden text-center border-b-2 pb-2  text-2xl font-bold leading-tight text-transparent h bg-gradient-to-br from-pink-500 to-indigo-900 bg-clip-text">
              OUR RESERVES
            </p>
              ...
              <div className="flex flex-col gap-5">
                <p className="flex flex-row gap-10 h-fit">
                  <div className="flex items-center justify-center gap-2 h-fit ">
                    Bank Transfer <img src={bank} alt="" />
                  </div>{" "}
                  <p>NGN</p>{" "}
                </p>
                <p className="self-end">
                  {" "}
                  <b>#3452030300303.24/$ </b>{" "}
                </p>
              </div>
            ...
            <div className="flex flex-col gap-2 lg:mt-1">
              <button className="self-end p-1 text-xs text-white rounded-md bg-gradient-to-br from-pink-500 to-indigo-900">
                8 hours ago
              </button>
              ...
              <p className="flex items-center justify-start gap-2 py-3 border-b-2">
                <p className="whitespace-nowrap">
                  <b>1.16</b> BTC
                </p>{" "}
                <img src={DoubleTrans} alt="" />{" "}
                <p className="lg:whitespace-nowrap">
                  <b>696152299929.23</b> NGN
                </p>{" "}
              </p>
...
<img src={pathBottom}  className="w-full " alt="" />
