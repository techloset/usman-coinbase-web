...
const newsletter = ({height}) => {
  return (
    <div     className={`  md:mb-[91px] ${height!='fit'? 'h-[500px] md:h-[600px] xl:h-[700px] ':'h-fit'}   flex gap-5 justify-center  md:justify-end flex-col items-center`}> 
      ...
      <p className='text-center sm:w-auto mb-[52px] '>Subscribe to our newsletter for daily/weekly <br className='sm:block hidden' /> update of our products and services.</p>
