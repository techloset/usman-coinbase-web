...
const newsletter = ({height}) => {
  return (
    <div     className={`  md:mb-[91px] ${height!='fit'? ' h-[350px] lg:h-[450px] 2xl:h-[550px]  ':'h-fit'}   flex gap-5 justify-center  md:justify-end flex-col items-center`}> 
      ...
      <p className='text-center sm:w-auto w-[90%] mb-[52px] '>Subscribe to our newsletter for daily/weekly <br className='sm:block hidden' /> update of our products and services.</p>
