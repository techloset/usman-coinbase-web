...
import bank from './bank-building.png'
import Transfer from './Transfer.png'
import DoubleTrans from './DoubleT.png'
import Group2 from './Group2.png'
import './rates.css'
const Rates = () => {
  return (

    <div style={{backgroundImage:`url(${bg})`}} className='w-full bg-center h-[900px] bg-no-repeat bg-cover flex justify-center items-center '>
      <div className='w-[80%] sm:w-[50%] lg:w-[1000px] h-[300px]  shadow-xl scroll scroll rounded-3xl overflow-y-auto mt-36 bg-white '>
...
<p className='flex items-center justify-start gap-2 border-b-2'><p className='whitespace-nowrap'><b>1.16</b> BTC</p> <img src={DoubleTrans} alt="" /> <p className='lg:whitespace-nowrap' ><b>696152299929.23</b> NGN</p> </p>
